...
public:
    ...
    UnrolledLinkedList(std::string name1,std::string name2):file_name_all(name1),file_name_lead(name2){
    ...
    std::vector<_value_type> Traverse(){
        ...
        //std::vector<_value_type>* v_all=new _value_type [element_count+2];
        //v_real.reserve(element_count+2);
        lead_search.clear();
        lead_search.open(file_name_lead);
        index_.clear();
        index_.open(file_name_all);
